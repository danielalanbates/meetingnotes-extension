...
chrome.tabs.onUpdated.addListener(async (tabId, changeInfo, tab) => {
  ...
  if (changeInfo.url && activeMeetings.has(tabId)) {
    ...
    const isMeetingPlatform =
      ...
      url.hostname.includes('bluejeans.com') ||
      url.hostname.includes('gotomeeting.com') ||
      url.hostname.includes('ringcentral.com') ||
      url.hostname.includes('skype.com') ||
      url.hostname.includes('slack.com') ||
      url.hostname.includes('dialpad.com') ||
      url.hostname.includes('chime.aws') ||
      url.hostname.includes('discord.com') ||
      url.hostname.includes('jitsi') ||
      url.hostname.includes('meet.jit.si') ||
      url.hostname.includes('around.co');
